  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          role="menu"
          className="absolute right-0 top-full z-50 mt-2 min-w-[220px] rounded-2xl border border-slate-200/90 bg-white/95 py-2 shadow-xl backdrop-blur dark:border-white/15 dark:bg-[#0c1220]/95"
        >
